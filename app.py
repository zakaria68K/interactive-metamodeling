...
# Each question has exactly 2 correct options and 2 incorrect ones — shown
# above every questionnaire so participants know to select more than one
...
if __name__ == "__main__":
    ...
    # that artificial cap; the real ceiling for concurrent study participants
    # becomes the OpenAI account's own rate limits, not this app.
    demo.queue(default_concurrency_limit=None)
    demo.launch(server_name="0.0.0.0", server_port=7860, share=share,
               theme=gr.themes.Soft(), css=CSS, head=FONT_HEAD, max_threads=100)